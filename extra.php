...
function fetchdata($id,$handle,$gid){
    ...
    $url = "https://22bet.ng/LineFeed/GetGameZip?id=$id&lng=en&cfview=0&isSubGames=true&GroupEvents=true&allEventsGroupSubGames=true&countevents=2500&partner=159&marketType=1";
...
function fetch_others($id,$handle,$gid){
    ...
    $url = "https://22bet.ng/LineFeed/GetGameZip?id=$id&lng=en&cfview=0&isSubGames=true&GroupEvents=true&allEventsGroupSubGames=true&countevents2500&partner=159&marketType=1";
       curl_setopt_array($handle,
        array(
            CURLOPT_URL => $url,
            CURLOPT_RETURNTRANSFER => true
...
function getLeagues($sport){
    ...
    $url = "https://22bet.ng/LineFeed/GetChampsZip?sport=$sports[$sport]&lng=en&tf=2200000&tz=1&country=132&partner=159&virtualSports=true";
    $handles = curl_init();
...
function getGames($id,$league,$table){
    ...
    $url = "https://22bet.ng/LineFeed/GetChampZip?champ=$id&lng=en&tf=2200000&tz=1&country=132&partner=159&virtualSports=true&group=173";
    $games = [];
    $handles = curl_init();
    curl_setopt_array($handles,
        array(
...
function getRecent($table){
    //$url = "https://22bet.ng/LineFeed/Get1x2_VZip?sports=1&count=1000&lng=en&tf=3000000&tz=1&mode=4&partner=151&getEmpty=true";
    $url = "https://22bet.ng/LineFeed/Get1x2_VZip?count=2000&lng=en&tf=3000000&tz=1&mode=4&partner=151";
    $games = [];
    $handles = curl_init();
    curl_setopt_array($handles,
        array(
