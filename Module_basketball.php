...
class Module_basketball
{
    ...
    public function initLoad(){
        try{
            $sql = "TRUNCATE TABLE bet22_basketball RESTART IDENTITY CASCADE";
    ...
    private function matchId(){
        $sql = "select matchid,fhid,shid,fqid,sqid,tqid,ftqid from bet22_basketball";
    ...
    public function m_1x2($match,$gid,$standard){
        $outcome = [];
          ...
          insertOutcomes($outcome,$standard,'bet22_basketball');
    }
    public function fh_1x2($match,$gid,$standard){
        ...
        insertOutcomesOthers($outcome,$standard,'bet22_basketball','fhid');
    }
    public function sh_1x2($match,$gid,$standard){
        ...
        insertOutcomesOthers($outcome,$standard,'bet22_basketball','shid');
    }
    public function first_quarter_1x2($match,$gid,$standard){
        ...
        insertOutcomesOthers($outcome,$standard,'bet22_basketball','fqid');
    }
    public function second_quarter_1x2($match,$gid,$standard){
        ...
        insertOutcomesOthers($outcome,$standard,'bet22_basketball','sqid');
    }
    public function third_quarter_1x2($match,$gid,$standard){
        ...
        insertOutcomesOthers($outcome,$standard,'bet22_basketball','tqid');
    }
    public function fourth_quarter_1x2($match,$gid,$standard){
        ...
        insertOutcomesOthers($outcome,$standard,'bet22_basketball','ftqid');
    }
